...
CREATE TABLE `st_authority`  (
  ...
  `name` varchar(64) CHARACTER NULL DEFAULT NULL COMMENT '权限名称',
  `code` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '权限编码',
  `full_id` varchar(200) CHARACTER NULL DEFAULT NULL COMMENT '编号路径',
  `authority_desc` varchar(200) CHARACTER NULL DEFAULT NULL COMMENT '权限描述',
  `show_order` int(11) NULL DEFAULT NULL COMMENT '排序',
  `pid` bigint(20) NULL DEFAULT NULL COMMENT '父Id',
  `yn_flag` char(2) CHARACTER NULL DEFAULT NULL COMMENT '有效标志',
  `creator` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '创建人',
  `editor` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `st_resource`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(64) CHARACTER NOT NULL COMMENT '菜单名称',
  `full_id` varchar(200) CHARACTER NULL DEFAULT NULL COMMENT '菜单编号路径',
  `icon_class` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '图标样式类',
  `show_order` int(11) NULL DEFAULT NULL COMMENT '排序',
  `url` varchar(64) CHARACTER NULL DEFAULT NULL COMMENT '链接',
  `component` varchar(128) CHARACTER NULL DEFAULT NULL COMMENT '页面路径',
  `authority_id` bigint(20) NULL DEFAULT NULL COMMENT '权限ID',
  `pid` bigint(20) NULL DEFAULT NULL COMMENT '父id',
  `resource_desc` varchar(200) CHARACTER NULL DEFAULT NULL COMMENT '菜单描述',
  `yn_flag` char(2) CHARACTER NULL DEFAULT NULL COMMENT '有效标志',
  `creator` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '创建人',
  `editor` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '修改人',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `st_role`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(64) CHARACTER NOT NULL COMMENT '角色名称',
  `role_desc` varchar(200) CHARACTER NULL DEFAULT NULL COMMENT '角色描述',
  `yn_flag` char(2) CHARACTER NULL DEFAULT NULL COMMENT '有效标志',
  `creator` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '创建人',
  `editor` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '修改人',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `st_user`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `account` varchar(64) CHARACTER NOT NULL COMMENT '账号',
  `name` varchar(128) CHARACTER NULL DEFAULT NULL COMMENT '姓名',
  `password` varchar(128) CHARACTER NULL DEFAULT NULL COMMENT '密码',
  `email` varchar(128) CHARACTER NULL DEFAULT NULL COMMENT '邮箱',
  `last_pwd_modified_time` datetime(0) NULL DEFAULT NULL COMMENT '上次修改密码时间',
  `status` char(2) CHARACTER NULL DEFAULT '0' COMMENT '状态',
  `yn_flag` char(2) CHARACTER NULL DEFAULT NULL COMMENT '有效标志',
  `creator` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '创建人',
  `editor` varchar(32) CHARACTER NULL DEFAULT NULL COMMENT '修改人',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `modified_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  `erp_flag` char(2) CHARACTER NULL DEFAULT NULL COMMENT 'ERP账号标识',
  PRIMARY KEY (`id`) USING BTREE
